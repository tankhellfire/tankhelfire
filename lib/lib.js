...
lib.cache={}
if(!typeof require==="undefined"){global.lib=module.exports=lib}
else if(typeof window==="undefined"){const exports=global.lib=lib}
else{const exports=window.lib=lib}